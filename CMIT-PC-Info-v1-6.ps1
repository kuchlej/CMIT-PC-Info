...
$Result = "" | Select Username,UserDomain,Manufacturer,Processor,Memory,Serialnumber,CSName,InstallDate,Buildnumber,AVName,AVDate,DiskType,Space,Freespace,TPMStatus,MoboMakeModel ## Create Object to hold the data
...
$TPM = Get-Tpm
$TPMStatus = $TPM.TpmPresent
$MoboInfo = wmic baseboard get product,manufacturer
$MoboMakeModel = $MoboInfo.split("`n")[2]
...
$disk = Get-PhysicalDisk | Sort-Object -Property DeviceID
$Result.DiskType = $disk[0].MediaType
$Result.Freespace = $Frees 
$Result.space = $Space
$Result.TPMStatus = $TPMStatus
$Result.MoboMakeModel = $MoboMakeModel
